    ...
    <div class="relative z-0">
      ...
      <div class="flex flex-col gap-2">
        ...
        <a href="{{ route('admin.screen') }}"
          ...
          {{ $isActive('admin.screen')
              ? 'bg-primary/10 text-primary font-bold'
              : 'text-gray-500 hover:bg-gray-100 hover:text-primary' }}">

          <span class="material-symbols-outlined
            {{ $isActive('admin.screen') ? 'text-primary' : '' }}">
            dashboard
          </span>
        ...
        <a href="{{ route('locations.screen') }}"
          ...
          <span class="material-symbols-outlined
            {{ $isActive('locations.*') ? 'text-primary' : '' }}">
            location_on
          </span>
        ...
        <a href="{{ route('criteria.screen') }}"
          ...
          <span class="material-symbols-outlined
            {{ $isActive('criteria.*') ? 'text-primary' : '' }}">
            rule
          </span>
