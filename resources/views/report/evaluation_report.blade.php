      ...
      <div id="pdf-preview"
        ...
        <div class="flex flex-col gap-3">
          ...
          <p class="text-xs leading-relaxed text-gray-600">
            {{ old('evaluator_notes', $judgment->evaluator_notes) }}
          </p>
        </div>
        ...
        <div class="flex flex-col gap-3 mt-2 flex-1">
          ...
          @foreach($project->projectIndustries as $projectIndustry)
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-3">
              {{ $projectIndustry->industry->industry_name ?? 'Unknown Industry' }}
            </h2>
            <table class="w-full text-left text-xs border-collapse">
              ...
              <tbody class="text-gray-600">
                @foreach(optional($projectIndustry->judgment)->details ?? [] as $detail)
                  @php
