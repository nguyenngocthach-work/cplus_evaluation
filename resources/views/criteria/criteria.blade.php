    ...
    <main class="flex flex-1 justify-center py-5 px-4 md:px-10 lg:px-40">
      <div class="layout-content-container flex flex-col max-w-[1200px] flex-1">
        ...
        <div class="flex flex-wrap gap-2 px-4 py-2">
          <a class="text-[#617589] dark:text-gray-400 text-sm font-medium hover:underline" href="{{ route('admin.screen') }}">Dashboard</a>
        ...
        <div
          ...
          <div class="hidden sm:flex flex-1 sm:items-center sm:justify-between">
            <div class="mt-4 flex justify-end">
              {{ $criteria->withQueryString()->links() }}
            </div>
          </div>
        </div>
      </div>
...
<script>
const CRITERIA_LIST = @json($criteria->items());
