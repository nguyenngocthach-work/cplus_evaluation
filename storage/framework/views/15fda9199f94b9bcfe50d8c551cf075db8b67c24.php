<?php $__env->startSection('title','Update Project'); ?>
...
<main class="flex-1 flex flex-col items-center py-8 px-4 md:px-10 lg:px-40">
  <div class="w-full max-w-[960px] flex flex-col gap-6">
    ...
    <div class="flex flex-wrap gap-2 px-4">
      <a class="text-[#617589] dark:text-gray-400 text-base font-medium hover:text-primary transition-colors" href="<?php echo e(route('admin.screen')); ?>">Dashboard</a>
      <span class="text-[#617589] dark:text-gray-400 text-base font-medium">/</span>
      <a class="text-[#617589] dark:text-gray-400 text-base font-medium hover:text-primary transition-colors" href="<?php echo e(route('projects.screen')); ?>">Projects</a>
      <span class="text-[#617589] dark:text-gray-400 text-base font-medium">/</span>
      ...
      <div class="bg-white dark:bg-[#1a2632] rounded-xl border border-[#e5e7eb] dark:border-gray-700 shadow-sm">
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $project->industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<script>
// ==================== DATA FROM BLADE ====================
const projectIndustries = <?php echo json_encode($project->industries->values(), 15, 512) ?>;

let evaluationState   = <?php echo json_encode($evaluationState, 15, 512) ?>;
