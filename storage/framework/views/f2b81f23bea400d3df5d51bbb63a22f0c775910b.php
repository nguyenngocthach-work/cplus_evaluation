...
<?php $__env->startSection('title','Project Details & Evaluation'); ?>
...
<form action="<?php echo e(route('projects.evaluationsScore')); ?>" method="POST" id="evaluation-form">
  <?php echo csrf_field(); ?>
  <input type="hidden" name="project_id" value="<?php echo e(old('project_id', $project->project_id)); ?>">
  <main class="flex-1 w-full max-w-[1440px] mx-auto p-4 md:p-8 lg:p-10 gap-6 flex flex-col">
    <!-- Breadcrumbs -->
    <div class="flex flex-wrap gap-2 items-center text-sm">
      <a class="text-[#617589] hover:text-primary transition-colors font-medium" href="<?php echo e(route('admin.screen')); ?>">Home</a>
      <span class="material-symbols-outlined text-[#617589] text-[16px]">chevron_right</span>
      <a class="text-[#617589] hover:text-primary transition-colors font-medium" href="<?php echo e(route('projects.screen')); ?>">Projects</a>
      <span class="material-symbols-outlined text-[#617589] text-[16px]">chevron_right</span>
      <span class="text-[#111418] dark:text-white font-semibold"><?php echo e($project->project_name); ?></span>
    </div>
    <?php
    $statusMap = [
    ...
    <div class="flex flex-col md:flex-row md:items-start justify-between gap-4">
      <div class="flex flex-col gap-2">
        <h1 class="text-3xl md:text-4xl font-black leading-tight tracking-[-0.033em]"><?php echo e($project->project_name); ?></h1>
        <div class="flex flex-wrap items-center gap-3 text-[#617589] text-sm">
          <span
            class="px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wider
                  <?php echo e($statusMap[$project->status]['color']); ?>">
            <?php echo e($statusMap[$project->status]['label']); ?>

          </span>
          <span>•</span>
          <span>Project ID: <?php echo e(old('project_id', $project->project_id)); ?></span>
          <span>•</span>
          <span>Created on <?php echo e(old('start_date', \Carbon\Carbon::parse($project->start_date)->format('M d, Y'))); ?></span>
        </div>
      </div>
      <div class="flex gap-3">
        ...
        <a href="<?php echo e(route('projects.reportById', $project)); ?>"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div class="flex flex-col gap-1 pb-4 border-b border-[#f0f2f4] dark:border-[#2d3748]">
                ...
                <div class="flex items-center gap-2">
                  <div
                    ...
                    A</div>
                  <p class="font-medium"><?php echo e(old('company_name', $project->client->company_name)); ?></p>
                </div>
              </div>
              <div class=" flex flex-col gap-1 pb-4 border-b border-[#f0f2f4] dark:border-[#2d3748]">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <p class="font-medium"><?php echo e(old('client_name', $project->client->client_name)); ?></p>
                </div>
              </div>
              <div class="flex flex-col gap-1 pb-4 border-b border-[#f0f2f4] dark:border-[#2d3748]">
                <p class="text-[#617589] text-xs uppercase font-semibold tracking-wider">Due Date</p>
                <p class="font-medium">
                  <?php echo e(old('end_date', \Carbon\Carbon::parse($project->end_date)->format('M d, Y'))); ?>

                </p>
              </div>
              <div class="flex flex-col gap-1">
                <p class="text-[#617589] text-xs uppercase font-semibold tracking-wider">Description</p>
                <p class="text-sm text-[#617589] leading-relaxed"><?php echo e(old('description', $project->description)); ?></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="lg:col-span-8 flex flex-col h-full">
        ...
        <div class="flex border-b border-[#dbe0e6] dark:border-[#4a5568] gap-8 mb-6 overflow-x-auto hide-scrollbar">
          <?php $__currentLoopData = $project->projectIndustries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <button type="button"
            class="location-tab <?php echo e($pi === 0 ? 'active' : ''); ?> flex items-center gap-2 border-b-[3px] border-b-primary text-primary pb-3 px-1 whitespace-nowrap outline-none group"
            data-project-industry-id="<?php echo e($pi->id); ?>"
            data-industry-id="<?php echo e($pi->industry->id); ?>">
            <span class="material-symbols-outlined text-[20px]">storefront</span>
            <span class="text-sm font-bold tracking-[0.015em]"><?php echo e($pi->industry->industry_name); ?></span>
          </button>
        ...
        <div
          ...
          <div
            ...
            <div>
              ...
              <p class="text-sm text-[#617589]">Last updated just now by You <?php echo e(old('userId', $project->userId)); ?></p>
            </div>
            <div
          ...
          <div
            ...
            <div class="p-6 xl:w-1/2 flex flex-col gap-6">
              ...
              <?php $__currentLoopData = $project->criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <!-- Criterion 1 -->
              <div class="group">
                <div class="flex justify-between items-end mb-2">
                  <label class="font-bold text-sm text-[#111418] dark:text-white flex items-center gap-2">
                    ...
                    <?php echo e(old('criteria_name', $criterion->criteria_name)); ?>

                  </label>
                  <span class="score-value font-bold text-primary text-sm bg-primary/10 px-2 py-0.5 rounded"><?php echo e($criterion->pivot->weight); ?></span>
                </div>
                ...
                <input
                  ...
                  max="<?php echo e($criterion->pivot->weight); ?>" min="0" step="0.5" type="range" value="5.0"
                  data-name="<?php echo e($criterion->criteria_name); ?>"
                  data-criteria-id="<?php echo e($criterion->id); ?>"
                  data-weight="<?php echo e($criterion->pivot->weight); ?>" />
...
<script>
window.projectIndustryMap = <?php echo json_encode(
  $project->projectIndustries->pluck('id', 'industry_id'), 512) ?>;
let evaluationState = {};
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\react\work\evaluation\evaluation\resources\views/evaluations/evaluations.blade.php ENDPATH**/ ?>