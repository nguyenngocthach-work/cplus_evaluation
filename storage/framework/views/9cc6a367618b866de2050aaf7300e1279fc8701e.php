    <header
      ...
      <div class="flex flex-1 justify-end gap-8">
        <div class="hidden md:flex items-center gap-9">
          ...
          <a class="text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal hover:text-primary transition-colors"
            href="<?php echo e(route('locations.screen')); ?>">Locations</a>
          <a class="text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal hover:text-primary transition-colors"
            href="<?php echo e(route('clients.screen')); ?>">Clients</a>
          <a class="text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal hover:text-primary transition-colors"
    ...
    </header><?php /**PATH D:\react\work\evaluation\evaluation\resources\views/layouts/sessions/header/top.blade.php ENDPATH**/ ?>