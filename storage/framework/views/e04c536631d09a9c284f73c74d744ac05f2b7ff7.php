...
<div class="max-w-[1000px] mx-auto p-6 font-sans text-[#334155]">
  ...
  <nav aria-label="breadcrumb" class="mb-4">
    <ol class="flex text-sm text-gray-500 gap-2">
      ...
      <li>Clients</li>
      <li>/</li>
      <li class="font-medium text-blue-600">Update Client</li>
    </ol>
  </nav>
  ...
  <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
    <div>
      <h2 class="text-3xl font-bold text-slate-800">Update Client</h2>
      <p class="text-gray-500 mt-1">
        Enter the details below to update a client in the system.
      </p>
    </div>
  ...
  <form id="clientForm" method="POST" action="<?php echo e(route('clients.update', $client->id)); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="space-y-2">
            ...
            <input type="text" name="client_name" placeholder="e.g. Acme Corp" required
              value="<?php echo e(old('client_name', $client->client_name)); ?>"
          ...
          <div class="space-y-2">
            ...
            <input type="text" name="company_name" value="<?php echo e(old('company_name', $client->company_name)); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="space-y-2">
            ...
            <input type="text" name="client_contact_name"
              value="<?php echo e(old('client_contact_name', $client->client_contact_name)); ?>" placeholder="Full Name" require
              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
          </div>
          <div class="space-y-2">
          ...
          <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700">Contact Person Phone <span
                class="text-red-500">*</span></label>
            <input type="text" name="contact_number" value="<?php echo e(old('contact_number', $client->contact_number)); ?>"
              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
          </div>
        </div>
      </section>
        ...
        <div class="grid grid-cols-1 gap-6">
          <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-700">Company Address <span
                class="text-red-500">*</span></label>
            <input type="text" name="client_HQ" value="<?php echo e(old('client_HQ', optional($client->location)->client_HQ)); ?>"
          ...
          <div class="space-y-2">
            ...
            <input type="text" name="client_billing"
              value="<?php echo e(old('client_billing', optional($client->location)->client_billing)); ?>"
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="space-y-2">
              ...
              <input type="text" name="client_country"
                value="<?php echo e(old('client_country', optional($client->location)->client_country)); ?>" placeholder="Country"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
            </div>
            <div class="space-y-2">
              ...
              <input type="text" name="client_city"
                value="<?php echo e(old('client_city', optional($client->location)->client_city)); ?>" placeholder="City"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
            </div>
            <div class="space-y-2">
              ...
              <input type="text" name="client_state_province"
                value="<?php echo e(old('client_state_province', optional($client->location)->client_state_province)); ?>"
                placeholder="State"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
            </div>
            <div class="space-y-2">
              ...
              <input type="text" name="client_zipcode"
                value="<?php echo e(old('client_zipcode', optional($client->location)->client_zipcode)); ?>" placeholder="Zip Code"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
            </div>
          </div>
        </div>
        ...
        <div class="space-y-4">
          <div class="space-y-2">
            ...
            <textarea name="notes" rows="4"
              ...
              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"><?php echo e(old('notes', $client->notes)); ?></textarea>
          </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sit27847/domains/sitelocationadviser.com/public_html/evaluation/resources/views/clients/client_update.blade.php ENDPATH**/ ?>