...
<main class="flex-1 flex flex-col items-center py-8 px-4 md:px-10 lg:px-40">
  <div class="w-full max-w-[960px] flex flex-col gap-6">
    ...
    <div class="flex flex-wrap gap-2 px-4">
      <a class="text-[#617589] dark:text-gray-400 text-base font-medium leading-normal hover:text-primary transition-colors" href="<?php echo e(route('admin.screen')); ?>">Dashboard</a>
      <span class="text-[#617589] dark:text-gray-400 text-base font-medium leading-normal">/</span>
      <a class="text-[#617589] dark:text-gray-400 text-base font-medium leading-normal hover:text-primary transition-colors" href="<?php echo e(route('projects.screen')); ?>">Projects</a>
      <span class="text-[#617589] dark:text-gray-400 text-base font-medium leading-normal">/</span>
    ...
    <!-- Main Form -->
    <form id="project-form" method="POST" action="<?php echo e(route('projects.store')); ?>" class="flex flex-col gap-6">
      <?php echo csrf_field(); ?>
...
<script>
  const allClients              = <?php echo json_encode($client, 15, 512) ?>;
  const allLocations            = <?php echo json_encode($locations, 15, 512) ?>;
  const criteriaData            = <?php echo json_encode($criteria, 15, 512) ?>;
  const defaultCriteriaByLocation = <?php echo json_encode($defaultCriteriaByLocation, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sit27847/domains/sitelocationadviser.com/public_html/evaluation/resources/views/project/project_add.blade.php ENDPATH**/ ?>