  ...
  <div class="flex flex-1 overflow-hidden">
    ...
    <aside
      ...
      <div class="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-1">
        ...
        <!-- Active Item -->
        <div onclick="selectLocation(this)" data-json='<?php echo json_encode($location, 15, 512) ?>'
    ...
    data.photos.forEach(photo => {
      const imgHtml = `
        <div class="relative aspect-square group rounded-lg overflow-hidden">
          <input type="hidden" name="keep_photos[]" value="${photo.img_id}">
          ...
          <button type="button"
            onclick="removePhoto(this, ${photo.img_id})"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sit27847/domains/sitelocationadviser.com/public_html/evaluation/resources/views/locations/locations.blade.php ENDPATH**/ ?>