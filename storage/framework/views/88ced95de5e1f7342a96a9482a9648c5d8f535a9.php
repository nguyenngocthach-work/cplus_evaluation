      ...
      <div class="max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div class="flex gap-3">
            ...
            <a href="<?php echo e(route('projects.create.screen')); ?>"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div
            ...
            <p class="text-[#111418] dark:text-white text-2xl font-bold mt-1"><?php echo e($totalClients); ?></p>
          </div>
          <div
            class="bg-white dark:bg-[#1a202c] rounded-xl p-5 border border-[#e5e7eb] dark:border-[#2a3441] shadow-sm hover:shadow-md transition-shadow">
            <div class="flex justify-between items-start mb-4">
            ...
            <p class="text-[#111418] dark:text-white text-2xl font-bold mt-1"><?php echo e($totalLocation); ?></p>
          </div>
          <div
            class="bg-white dark:bg-[#1a202c] rounded-xl p-5 border border-[#e5e7eb] dark:border-[#2a3441] shadow-sm hover:shadow-md transition-shadow">
            <div class="flex justify-between items-start mb-4">
            ...
            <p class="text-[#111418] dark:text-white text-2xl font-bold mt-1"><?php echo e($totalProject); ?></p>
          </div>
          <div
            class="bg-white dark:bg-[#1a202c] rounded-xl p-5 border border-[#e5e7eb] dark:border-[#2a3441] shadow-sm hover:shadow-md transition-shadow">
            <div class="flex justify-between items-start mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <a href="<?php echo e(route('locations.create.screen')); ?>"
            class="flex items-center gap-4 p-4 bg-white dark:bg-[#1a202c] border border-[#e5e7eb] dark:border-[#2a3441] rounded-xl hover:border-primary/50 hover:shadow-md transition-all group text-left">
            <div
              class="size-12 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors text-primary">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div
            ...
            <div class="p-5 border-b border-[#e5e7eb] dark:border-[#2a3441] flex justify-between items-center">
              ...
              <a class="text-sm font-bold text-primary hover:text-blue-700" href="<?php echo e(route('projects.screen')); ?>">View
                All</a>
            </div>
            <div class="overflow-x-auto">
              <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-[#e5e7eb] dark:divide-[#2a3441]">
                  ...
                  ?>
                  <?php $__empty_1 = true; $__currentLoopData = $activeProjectList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <?php
                  ...
                  <tr class="hover:bg-[#f9fafb] dark:hover:bg-[#2d3748]/50 transition-colors">
                    <td class="p-4">
                      <div class="font-bold text-[#111418] dark:text-white">
                        <?php echo e($projectList->project_name ?? '-'); ?>

                      </div>
                      <div class="text-xs text-[#617589] dark:text-[#9ca3af]">Due:
                        <?php echo e(\Carbon\Carbon::parse($projectList->end_date)->format('M d, Y')); ?></div>
                    </td>
                    <td class="p-4 text-sm text-[#111418] dark:text-white">
                      <?php echo e($projectList->client->client_name ?? '-'); ?></td>
                    <td class="p-4">
                      <span
                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-200 <?php echo e($status['badge']); ?>">
                    ...
                    <td class="p-4 w-32">
                      <div class="flex items-center gap-2">
                        <div class="w-full bg-[#e5e7eb] dark:bg-[#4a5568] rounded-full h-1.5">
                          <div class="<?php echo e($status['bar']); ?> h-1.5 rounded-full"
                            style="width: <?php echo e($status['progress']); ?>%">
                          </div>
                        </div>
                        <span class="text-xs font-medium text-[#617589] dark:text-[#9ca3af]">
                          <?php echo e($status['progress']); ?>%
                        </span>
                      </div>
                    </td>
    ...
    <div class="bg-white dark:bg-[#1a202c] w-full max-w-lg rounded-xl shadow-lg p-6">
      <h3 class="text-lg font-bold mb-4 text-[#111418] dark:text-white">
        ...
        <select id="projectSelect"
          ...
          <?php $__currentLoopData = $activeProjectList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sit27847/domains/sitelocationadviser.com/public_html/evaluation/resources/views/admin/admin_dashboard.blade.php ENDPATH**/ ?>