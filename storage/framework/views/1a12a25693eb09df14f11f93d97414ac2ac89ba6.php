...
<?php $__env->startSection('title','Evaluation Report Export'); ?>
...
<div class="flex-1 flex flex-col w-full max-w-[1440px] mx-auto px-4 md:px-10 py-6 pb-24">
  ...
  <div class="flex flex-wrap gap-2 py-2 mb-4">
    <a class="text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal hover:text-primary" href="<?php echo e(route('admin.screen')); ?>">Home</a>
    ...
    <span class="text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal">/</span>
    <a class="text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal hover:text-primary"
      href="<?php echo e(route('projects.getEvaluationsId', $project)); ?>">Project
      <?php echo e(old('project_id', $project->project_id)); ?></a>
    <span class="text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal">/</span>
    ...
    <div class="flex flex-col gap-2">
      ...
      <p class="text-[#617589] dark:text-gray-400 text-base font-normal leading-normal">Review details and configure
        settings before generating the final PDF document.</p>
            ...
            <?php
            $judgment = $project->projectIndustries
              ->pluck('judgment')
              ->filter()
              ->first();
          ?>
      ...
      <div class="bg-white dark:bg-[#1A2633] rounded-xl border border-[#dbe0e6] dark:border-[#2a3441] p-6 shadow-sm">
        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-2">
            ...
            <input
              class="w-full bg-[#f6f7f8] dark:bg-[#101922] border border-[#dbe0e6] dark:border-[#2a3441] rounded-lg px-4 py-2.5 text-sm text-[#111418] dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
              type="text" value="<?php echo e(old('client_name', $project->client->client_name)); ?>" />
          </div>
      ...
      <div id="pdf-preview"
        ...
        <div class="flex justify-between items-start border-b-2 border-primary pb-6">
          <div class="flex flex-col gap-1">
            <h2 class="text-2xl font-bold tracking-tight text-gray-900" id="preview-title"><?php echo e($defaultTitle); ?>

            </h2>
            <p class="text-sm text-gray-500 uppercase tracking-widest font-semibold">Project
              <?php echo e(old('project_name', $project->project_name)); ?> - Client
              <?php echo e(old('client_name', $project->client->client_name)); ?>
          ...
          <div class="text-right flex flex-col items-end">
            ...
            <p class="text-xs text-gray-400">Date:
              <?php echo e(old('end_date', \Carbon\Carbon::parse($project->end_date)->format('M d, Y'))); ?></p>
        ...
        <div class="flex flex-col gap-3">
          ...
          <p class="text-xs leading-relaxed text-gray-600">
            <?php echo e(old('evaluator_notes', $judgment->evaluator_notes)); ?>
        ...
        <div class="flex flex-col gap-3 mt-2 flex-1">
          ...
          <?php $__currentLoopData = $project->projectIndustries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectIndustry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <h2 class="text-xl font-bold text-gray-800 mt-8 mb-3">
              <?php echo e($projectIndustry->industry->industry_name ?? 'Unknown Industry'); ?>
            ...
            <table class="w-full text-left text-xs border-collapse">
              ...
              <tbody class="text-gray-600">
                <?php $__currentLoopData = optional($projectIndustry->judgment)->details ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                    $score  = $detail->criteria_point ?? 0;
                    $weight = $detail->criteria_percentage ?? 10;
                    $half   = $weight / 2;
                  ...
                  <tr class="border-b border-gray-50">
                    <td class="py-2"><?php echo e($detail->criteriaId); ?></td>
                    <td class="py-2"><?php echo e($detail->criteria_name); ?></td>
                    <td class="py-2">
                      <span class="<?php echo e($badge); ?> px-1.5 py-0.5 rounded text-[10px] font-bold">
                        <?php echo e($status); ?>

                      </span>
                    </td>
                    <td class="py-2 text-right">
                      <?php echo e($score); ?>/<?php echo e($weight); ?>
...
document.getElementById('report-title').addEventListener('input', function() {
  ...
  document.getElementById('preview-title').innerText =
    value !== '' ? value : <?php echo json_encode($defaultTitle, 15, 512) ?>;
});
...
function handleExport() {
  ...
  if (selected === 'csv') {
    window.location.href = "<?php echo e(route('projects.exportCsv', $project)); ?>";
  } else {
    exportPDF();
  }
}
...
function exportPDF() {
  ...
  const reportTitle = titleInput.value.trim() || <?php echo json_encode($defaultTitle, 15, 512) ?>;
  ...
  html2pdf()
    .set({
      margin: [20, 15, 20, 15],
      filename: reportTitle.replace(/[^\w\d]+/g, '_') + '_<?php echo e($project->project_id); ?>.pdf',
      image: {
        type: 'jpeg',
        quality: 0.98
      },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sit27847/domains/sitelocationadviser.com/public_html/evaluation/resources/views/report/evaluation_report.blade.php ENDPATH**/ ?>