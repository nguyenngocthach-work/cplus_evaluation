  ...
  <div class="layout-container flex h-full grow flex-col">
    ...
    <main class="flex flex-1 justify-center py-5 px-4 md:px-10 lg:px-40">
      <div class="layout-content-container flex flex-col max-w-[1200px] flex-1">
        ...
        <!-- Toolbar / Filters -->
        <form method="GET" action="<?php echo e(route('projects.screen')); ?>">
          <div
            ...
            <tr class="group hover:bg-gray-50 dark:hover:bg-[#1f2b37] transition-colors">
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center gap-3">
                  <div>
                    <div class="text-sm font-bold text-[#111418] dark:text-white"><?php echo e($project->project_name); ?></div>
                    <div class="text-xs text-[#617589] dark:text-gray-400">ID: <?php echo e($project->project_id); ?></div>
                  </div>
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                ...
                ?>
                <?php if($industries->count() > 0): ?>
                <div class="text-sm text-[#111418] dark:text-white">
                  <?php echo e($industries->first()->industry_name); ?>

                  <?php if($industries->count() > 1): ?>
                  <span class="ml-1 text-xs text-primary cursor-pointer">
                    +<?php echo e($industries->count() - 1); ?> more
                  </span>
                  ...
                  <div
                    ...
                    <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div>• <?php echo e($industry->industry_name); ?></div>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <?php if($project->status < 3): ?> <a href="<?php echo e(route('projects.getId', $project)); ?>"
                    ...
                    <button type="button" onclick="openDeleteModal(<?php echo e($project->project_id); ?>)"
...
<div id="deleteProjectModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50">
...
<script>
function openDeleteModal(project_id) {
  const form = document.getElementById('deleteProjectForm');
  form.action = `/projects/${project_id}/delete`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sit27847/domains/sitelocationadviser.com/public_html/evaluation/resources/views/project/project.blade.php ENDPATH**/ ?>